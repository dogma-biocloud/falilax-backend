...
def persist_normalized_records_to_measurements(
    ...
    *,
    ...
    from app.services.measurement_alert_service import MeasurementAlertService
    ...
    created_count = 0
    alert_service = MeasurementAlertService()
    ...
    for record in normalized_records:
        ...
        if evaluation_status in {"attention", "critical"} and alert_user_id is not None:
            alert_service.create_alert_from_measurement(
                db=db,
